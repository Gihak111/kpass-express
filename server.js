...
// Flask 서버 URL 설정
const FLASK_SERVER_URL = 'https://magpie-intent-trivially.ngrok-free.app';  // 실제 Flask 서버 URL로 교체할 것
//https://port-0-kpass-flask-m0rc2yaj6eba411b.sel4.cloudtype.app   http://127.0.0.1:5000/
// 차단할 도메인 리스트
